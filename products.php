...
if(isset($_GET['c']) && isset($_GET['s'])){
 ...
 $sub_cat_qry = $conn->query("SELECT * FROM sub_categories where md5(id) = '{$_GET['s']}'");
    if($sub_cat_qry->num_rows > 0){
        ...
        $sub_product = $result['sub_category'];
...
<header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder"><?php echo $product ?></h1>
            <p class="lead fw-normal text-white-50 mb-0"><?php echo $sub_product ?></p>
        </div>
    </div>
</header>
<!-- Section-->
        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <div class="tab-content pt-2">
                <div class="tab-pane fade show active" id="book">
                    ...
                    <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-3">
                        ...
                        <?php 
                            $whereData = "";
                            if(isset($_GET['search']))
                                $whereData = " and (product LIKE '%{$_GET['search']}%' or brandname LIKE '%{$_GET['search']}%' or description LIKE '%{$_GET['search']}%')";
                        ...
                        <div class="col-md-12 mb-5">
                            <div class="card product-item">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <p class="m-0"><small>By: <?php echo $row['brandname'] ?></small></p>
                                </div>
                                <!-- Product actions-->
                ...
                <div class="tab-pane fade" id="details">
                    <h3 class="text-center"><?php echo $product. " Category" ?></h3>
                    <hr>
                    <div>
                        <?php echo isset($cat_description) ? stripslashes(html_entity_decode($cat_description)) : '' ?>
                    </div>
                    <h3 class="text-center"><?php echo $sub_product?></h3>
                    <hr>
                    <div>
