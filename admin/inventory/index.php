        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT i.*,p.product as product,p.brandname from `inventory` i inner join `products` p on p.id = i.product_id order by unix_timestamp(i.date_created) desc ");
					...
					?>
						<tr>
							...
							<td>
								...
								<p class="m-0 truncate"><b>Brand:</b> <?php echo $row['brandname'] ?></p>
							</td>
