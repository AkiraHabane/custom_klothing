	...
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
                ...
                <textarea name="product" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($product) ? $product : ''; ?></textarea>
			</div>
			<div class="form-group">
            <label for="brandname" class="control-label">Brand Name</label>
                <textarea name="brandname" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($author) ? $author : ''; ?></textarea>
			</div>
            <div class="form-group">
