    ...
    <div class="container">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <?php 
                    $qry = $conn->query("SELECT c.*,p.product,i.price,p.id as pid from `cart` c inner join `inventory` i on i.id=c.inventory_id inner join products p on p.id = i.product_id where c.client_id = ".$_settings->userdata('id'));
                ...
                ?>
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                <p class="mb-1 mb-sm-1"><?php echo $row['product'] ?></p>
